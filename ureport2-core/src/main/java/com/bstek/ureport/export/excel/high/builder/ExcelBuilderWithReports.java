...
import com.bstek.ureport.utils.UnitUtils;
 ...
 /**
  * @ClassName:  ExcelBuilderWithReports   
  * @Description:TODO(多报表多sheet页导出)   
  * @author: wl
  * @date:   2019年1月23日 下午2:30:11   
  */
public class ExcelBuilderWithReports extends ExcelBuilder {
	public void build(Report[] reports, OutputStream outputStream) {
		...
		try{
			for(int k=0;k<reports.length;k++) {
				...
				Sheet sheet=createSheet(wb, paper, report.getReportFullName());
