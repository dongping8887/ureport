...
public class ReportBuilder extends BasePagination implements ApplicationContextAware {
	 ...
	 * 
	 * @Title: buildReport   
	 * @Description: TODO(报表构建)   
	 * @param: @param reportDefinition
	 * @param: @param parameters
	 * @param: @return      
	 * @return: Report      
	 * @throws
	 */
	public Report buildReport(ReportDefinition reportDefinition, Map<String, Object> parameters,Map<String,DataSource> unionDsMap,String reportId) {
		Report report = reportDefinition.newReport();
		//
		Map<String, Dataset> datasetMap = buildDatasets(reportDefinition, parameters, applicationContext,unionDsMap);
	...
	private Map<String, Dataset> buildDatasets(ReportDefinition reportDefinition, Map<String, Object> parameters,
		...
		for (DatasourceDefinition dsDef : datasources) {
			...
			if (dsDef instanceof JdbcDatasourceDefinition) {
				...
				DataSource unionDs=unionDsMap.get(dsId);
				List<Dataset> ls = ds.buildDatasets(parameters,unionDs);
				if (ls != null) {
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		Collection<DatasourceProvider> datasourceProviders = applicationContext.getBeansOfType(DatasourceProvider.class)
				.values();
